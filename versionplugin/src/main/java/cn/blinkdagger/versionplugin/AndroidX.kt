...
object AndroidX {
    ...
    const val lifecycle_extend = "androidx.lifecycle:lifecycle-extensions:2.2.0"
    const val lifecycle_viewmodel = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.2.0"

    const val workRuntime = "androidx.work:work-runtime:2.2.0"
    const val workTesting = "androidx.work:work-testing:2.2.0"
