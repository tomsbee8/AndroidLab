package cn.blinkdagger.android.qrcode.camera.open;
...
public final class OpenCameraInterface {
  ...
  /** For {@link #open(int)}, means no PreferenceKey for which camera to open. */
   ...
   *  or {@link #NO_REQUESTED_CAMERA} means "no PreferenceKey", in which case a rear-facing
