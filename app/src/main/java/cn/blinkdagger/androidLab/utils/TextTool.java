...
public class TextTool {
    ...
    public static class Builder {
        ...
        public Builder setBackground(int drawableId, final int textColor, final int textSize) {
            imageSpan = new ImageSpan(AndroidLabApplication.getInstance().getResources().getDrawable(drawableId)) {
                @Override
                public void draw(Canvas canvas, CharSequence text, int start, int end, float x, int top, int y,
                    ...
                    getDrawable().setBounds(0, 0, len, textSize + 20);
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(AndroidLabApplication.getInstance(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(AndroidLabApplication.getInstance(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(AndroidLabApplication.getInstance(), resourceId), start, end, flag);
                    resourceId = 0;
