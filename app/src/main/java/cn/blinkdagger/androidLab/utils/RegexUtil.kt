...
object RegexUtil {
    ...
    fun isMobileSimple(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_MOBILE_SIMPLE, input)
    }
    ...
    fun isMobileExact(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_MOBILE_EXACT, input)
    }
    ...
    fun isTel(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_TEL, input)
    }
    ...
    fun isIDCard15(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_ID_CARD15, input)
    }
    ...
    fun isIDCard18(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_ID_CARD18, input)
    }
    ...
    fun isEmail(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_EMAIL, input)
    }
    ...
    fun isURL(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_URL, input)
    }
    ...
    fun isZh(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_ZH, input)
    }
    ...
    fun isUsername(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_USERNAME, input)
    }
    ...
    fun isDate(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_DATE, input)
    }
    ...
    fun isIP(input: CharSequence?): Boolean {
        return isMatch(UtilsConstants.REGEX_IP, input)
    }
